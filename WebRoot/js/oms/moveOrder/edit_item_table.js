...
$(document).ready(function() {
        ...
        "columns": [
            ...
            { "data": "WAREHOUSE_ID", 'visible':false,
                "render": function ( data, type, full, meta ) {
                    if(!data)
                        data='';
                    return '<input type="text" name="warehouse_id" value="'+data+'" class="form-control" />';
                }
            }, 
            { "data": "SHELVES", 
                "render": function ( data, type, full, meta ) {
            ...
            { "data": "TO_WAREHOUSE_ID", 'visible':false,
                "render": function ( data, type, full, meta ) {
                    if(!data)
                        data='';
                    return '<input type="text" name="to_warehouse_id" value="'+data+'" class="form-control" />';
                }
            },
            { "data": "TO_SHELVES", 
                "render": function ( data, type, full, meta ) {
                    if(!data)
                        data='';
                    return '<input type="text" name="to_shelves" value="'+data+'" class="form-control" />';
                }
            },
            { "data": "REMARK", 
                "render": function ( data, type, full, meta ) {
    ...
    itemOrder.refleshTable = function(order_id){
    	var url = "/moveOrder/tableList?order_id="+order_id
        +"&table_type=item";
