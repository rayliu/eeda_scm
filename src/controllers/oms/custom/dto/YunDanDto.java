...
public class YunDanDto {
    ...
    public String getDecl_code() {
        return decl_code;
    }
    public void setDecl_code(String decl_code) {
        this.decl_code = decl_code;
    }
    ...
    public String getReport_pay_no() {
        return report_pay_no;
    }
    public void setReport_pay_no(String report_pay_no) {
        this.report_pay_no = report_pay_no;
    }
