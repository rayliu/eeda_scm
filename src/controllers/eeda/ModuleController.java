...
//    ParentOfficeModel pom = ParentOffice.getInstance().getOfficeId(this);
    ...
    public void index() {
//        Long office_id = LoginUserController.getLoginUser(this).get("office_id");
...
//                +"where office_id="+LoginUserController.getLoginUser().get("office_id");
    ...
    public void addModule(){
    	...
    	String sql = "select max(seq) seq from eeda_modules where office_id="+office_id;
    ...
    private List<Record> getActionList(String module_id) {
        ...
        if(true){//user.isAdmin()
            ...
            action_list = Db.find(authSql, module_id, LoginUserController.getLoginUser(this).getStr("user_name"));
...
//            }
    ...
    private Record getStructureRecs(String module_id) {
        Record mRec = Db.findFirst("select * from eeda_module where module_id=?", module_id);
        return mRec;
    }
